...
class MachampBiaffineDependencyParser(Model):
    ...
    def forward(
        ...
        predicted_heads, predicted_head_tags, mask, arc_nll, tag_nll, arc_logits, head_tag_logits = self._parse(
        ...
        output_dict = {
            ...
            "logits": head_tag_logits, # TODO: We keep only head_tag logits for training dynamics, but in the future arc logits should be merged to head_tag logits
            "loss": loss,
            "log_training_dynamics": self.training_dynamics}
        return output_dict
    ...
    def _parse(
        ...
        if head_indices is not None and head_tags is not None:
            ...
            arc_nll, tag_nll, arc_logits, head_tag_logits = self._construct_loss(
        ...
        return predicted_heads, predicted_head_tags, mask, arc_nll, tag_nll, arc_logits, head_tag_logits
    ...
    def _construct_loss(
        ...
        return arc_nll, tag_nll, normalised_arc_logits, normalised_head_tag_logits
