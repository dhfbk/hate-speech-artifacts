        ...
        do
            ...
            do
                ...
                python machamp/predict.py \
                    ...
                    $BERT_RESULTS_FOLDER/$SOURCE_DATASET/$MODEL_NAME.$TARGET_DATASET.subset.out \
                    --device 0

                python scripts/compute_fpr.py \
                    --input_pred_filepath $BERT_RESULTS_FOLDER/$SOURCE_DATASET/$MODEL_NAME.$TARGET_DATASET.subset.out \
                    --input_gold_filepath $TEST_DATA_FOLDER/$TARGET_DATASET.$PRETRAINED_MODEL.sp-i.test \
                    --output_filepath $BERT_RESULTS_FOLDER/$SOURCE_DATASET/$MODEL_NAME.$TARGET_DATASET.fairness
